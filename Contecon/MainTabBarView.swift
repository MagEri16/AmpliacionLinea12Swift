...
//  AmpliacionLinea12New
//
//  Created by Erika Esther Torres Verdin on 23/05/17.
...
class MainTabBarView: UITabBarController, UITabBarControllerDelegate {
    ...
    func configureTabBar() {
        ...
        let tabBarItemHome =  UINavigationController(rootViewController:HomeViewController())
        let tabBarItemFavorites = UINavigationController(rootViewController: ProyectoEjecutivoViewController())
        let tabBarItemDirectory = UINavigationController(rootViewController: LiberacionViewController())
        let tabBarItemReports = UINavigationController(rootViewController: AvanceObraViewController())
        let tabBarItemSettings = UINavigationController(rootViewController: LevantamientosViewController())
